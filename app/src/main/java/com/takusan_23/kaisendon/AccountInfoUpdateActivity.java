...
*/
        ...
        TextView avater_image_post_message_textview = findViewById(R.id.account_update_avatar_textview_title);
        ...
        Button avatar_button = findViewById(R.id.account_update_avatar_button);
        Button header_button = findViewById(R.id.account_update_header_button);
