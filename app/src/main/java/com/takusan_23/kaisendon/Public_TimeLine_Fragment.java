...
/*
                                        ...
                                        System.out.println("FirstPosition : " + listView.getFirstVisiblePosition());
*/


//                                        System.out.println("Top : " + listView.getChildAt(0).getTop());


/*
                                        if (pos == 0 && finalTop == 0) {
                                            listView.smoothScrollToPosition(pos, 0);
                                            System.out.println("ねてた");
                                        }
*/
