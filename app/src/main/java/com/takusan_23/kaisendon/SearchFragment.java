                            ...
                            public void onResponse(Call call, Response response) throws IOException {
                                ...
                                try {
                                    ...
                                    for (int i = 0; i < toot_list.length(); i++) {
                                        ...
                                        ListItem listItem = new ListItem(null, toot, user_name + " @" + user, "クライアント : " + "null" + " / " + "トゥートID : " + toot_id_string + " / " + getString(R.string.time) + " : " + toot_time, toot_id_string, user_avater_url, account_id, user, null,null,null,null);
