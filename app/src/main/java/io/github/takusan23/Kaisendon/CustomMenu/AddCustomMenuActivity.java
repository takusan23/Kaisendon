        ...
        if (getIntent().getBooleanExtra("delete_button", false)) {
            ...
            delete_Button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Snackbar.make(v, R.string.custom_setting_delete_message, Snackbar.LENGTH_SHORT).setAction(R.string.delete_ok, new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!getIntent().getBooleanExtra("delete_button", false)) {
                    //新規作成
                    //SnackBer
                    Snackbar.make(v, R.string.custom_add_message, Snackbar.LENGTH_SHORT).setAction(R.string.register, new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            saveSQLite();
                            //戻る
                    ...
                    //SnackBer
                    Snackbar.make(v, R.string.custom_menu_update, Snackbar.LENGTH_SHORT).setAction(R.string.update, new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            //更新
                            String name = getIntent().getStringExtra("name");
