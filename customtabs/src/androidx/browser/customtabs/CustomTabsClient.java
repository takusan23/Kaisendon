...
public class CustomTabsClient {
    ...
    public static boolean bindCustomTabsService(Context context,
            String packageName, androidx.browser.customtabs.CustomTabsServiceConnection connection) {
    ...
    public static String getPackageName(
        ...
        Intent serviceIntent = new Intent(androidx.browser.customtabs.CustomTabsService.ACTION_CUSTOM_TABS_CONNECTION);
    ...
    public static boolean connectAndInitialize(Context context, String packageName) {
        ...
        androidx.browser.customtabs.CustomTabsServiceConnection connection = new androidx.browser.customtabs.CustomTabsServiceConnection() {
            @Override
     ...
     *         Null on error.
     */
    public androidx.browser.customtabs.CustomTabsSession newSession(final androidx.browser.customtabs.CustomTabsCallback callback) {
        ...
        return new androidx.browser.customtabs.CustomTabsSession(mService, wrapper, mServiceComponentName);
    }
