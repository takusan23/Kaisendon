...
public abstract class CustomTabsService extends Service {
    ...
    private ICustomTabsService.Stub mBinder = new ICustomTabsService.Stub() {
        ...
        public boolean newSession(ICustomTabsCallback callback) {
            final androidx.browser.customtabs.CustomTabsSessionToken sessionToken = new androidx.browser.customtabs.CustomTabsSessionToken(callback);
            try {
        ...
        public boolean mayLaunchUrl(ICustomTabsCallback callback, Uri url,
            ...
            return CustomTabsService.this.mayLaunchUrl(
                    new androidx.browser.customtabs.CustomTabsSessionToken(callback), url, extras, otherLikelyBundles);
        }
        ...
        public boolean updateVisuals(ICustomTabsCallback callback, Bundle bundle) {
            return CustomTabsService.this.updateVisuals(
                    new androidx.browser.customtabs.CustomTabsSessionToken(callback), bundle);
        }
        ...
        public boolean requestPostMessageChannel(ICustomTabsCallback callback,
            ...
            return CustomTabsService.this.requestPostMessageChannel(
                    new androidx.browser.customtabs.CustomTabsSessionToken(callback), postMessageOrigin);
        }
        ...
        public int postMessage(ICustomTabsCallback callback, String message, Bundle extras) {
            return CustomTabsService.this.postMessage(
                    new androidx.browser.customtabs.CustomTabsSessionToken(callback), message, extras);
        }
        ...
        public boolean validateRelationship(
            ...
            return CustomTabsService.this.validateRelationship(
                    new androidx.browser.customtabs.CustomTabsSessionToken(callback), relation, origin, extras);
        }
    };
     ...
     */
    protected boolean cleanUpSession(androidx.browser.customtabs.CustomTabsSessionToken sessionToken) {
        try {
            synchronized (mDeathRecipientMap) {
     ...
     */
    protected abstract boolean newSession(androidx.browser.customtabs.CustomTabsSessionToken sessionToken);
     ...
     */
    protected abstract boolean mayLaunchUrl(androidx.browser.customtabs.CustomTabsSessionToken sessionToken, Uri url,
                                            Bundle extras, List<Bundle> otherLikelyBundles);
     ...
     */
    protected abstract boolean updateVisuals(androidx.browser.customtabs.CustomTabsSessionToken sessionToken,
                                             Bundle bundle);
     ...
     * asynchronous.
     */
    protected abstract boolean requestPostMessageChannel(androidx.browser.customtabs.CustomTabsSessionToken sessionToken,
                                                         Uri postMessageOrigin);
    ...
    protected abstract int postMessage(
            androidx.browser.customtabs.CustomTabsSessionToken sessionToken, String message, Bundle extras);
    ...
    protected abstract boolean validateRelationship(
            androidx.browser.customtabs.CustomTabsSessionToken sessionToken, @Relation int relation, Uri origin,
            Bundle extras);
}
