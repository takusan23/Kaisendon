...
public abstract class PostMessageServiceConnection implements ServiceConnection {
    ...
    public PostMessageServiceConnection(androidx.browser.customtabs.CustomTabsSessionToken session) {
    ...
    public boolean bindSessionToPostMessageService(Context context, String packageName) {
        ...
        intent.setClassName(packageName, androidx.browser.customtabs.PostMessageService.class.getName());
